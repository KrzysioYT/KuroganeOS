...
This is a runnable KuroganeOS `console` SDK scaffold. It links statically
...
The output `build/sdk-console-probe` is an ELF64 ET_EXEC image. Copy it to the
system filesystem (normally `/apps/sdk-console-probe`) and launch it from the
