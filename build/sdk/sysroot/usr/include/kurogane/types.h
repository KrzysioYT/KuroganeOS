...
// Syscalls that return either a non-negative 64-bit value (handle, PID,
// byte count or pointer) or a negative ku_status_code use ku_result_t.
typedef int64_t ku_result_t;
