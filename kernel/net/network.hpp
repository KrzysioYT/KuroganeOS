...
// A normal TCP segment can carry close to one Ethernet MTU. The previous
// 512-byte inbox rejected valid HTTP response segments as BufferTooSmall,
// which surfaced in Kurogane Web as KU_STATUS_OUT_OF_RANGE (-2).
